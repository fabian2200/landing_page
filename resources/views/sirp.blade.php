...
<head>
   ...
   <meta property="og:image"            content="https://icp360rh.com/fondo4.jpg" />
    ...
    <meta property="og:image:alt"        content="Evaluación del Riesgo Psicosocial" />
    ...
    <!-- Iconos -->
    <link rel="image_src"   href="https://icp360rh.com/fondo4.jpg" />
    <link rel="icon"             href="https://icp360rh.com/icono-icp.png" />
    <link rel="apple-touch-icon" href="https://icp360rh.com/icono-icp.png" />
...
.section-number, .section-number svg {
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-12">
            <h2 class="clima-title" data-aos="fade-up" data-aos-delay="100">
              ¿Aplicaste la bateria de riesgo psicosocial?
            </h2>
            <br><br>
            ...
            <br><br>        
             <h3 style="text-shadow: 0 0 3px #000000, 0 0 5px #000000; color: white; font-size: 1.8rem;"
              ...
              <ul class="report-list">
                <li><strong>1. Informes Individuales</strong> (3 informes por cada empleado)</li>
                <li><strong>2. Informe Sociodemográfico</strong> (11 variables sociodemográficas y tabla comparativa)</li>
                <li><strong>3. Informe general por Departamento</strong> (Intra A y B por cada departamento)</li>
              </ul>
          ...
          <div class="final-message">
            <h2 style="text-shadow: 0 0 3px #000000, 0 0 5px #000000; color: white; font-size: 1.8rem;"
                data-aos="fade-up"
                data-aos-delay="100">
              Todo esto en segundos, con una muy baja inversión
            </h2>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
              <div class="icon-box">
                ...
                <div style="text-align: center; width: 100%;">
                  <img  src="/inicio/assets/img/sirp1.png" width="80%" alt="">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row gy-4 icon-boxes">
            <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
              <div class="icon-box">
                ...
                <h3>Paso 4: Digitar los datos sociodemográficos</h3>
                <h4>En este apartado de <strong style="font-style: italic;">SIRP v3.0 </strong> usted debe digitar los datos de la <strong style="font-style: italic;"> Ficha de Datos Generales </strong>que cada empleado haya diligenciado. Esta información es la fuente del Informe Sociodemográfico. </h4>
                <br>
                <div style="text-align: center; width: 100%;">
                  <img  src="/inicio/assets/img/registro.png" width="60%" alt="">
                </div>
              </div>
            </div>
          </div> 
...
<footer id="footer" class="footer position-relative light-background">
  <div class="container copyright text-center mt-4">
    ...
    <br>
    <p>© {{ date('Y') }} <span>Copyright</span> <strong class="sitename">ICP360RH - Instituto Colombiano de Psicometría ICP</strong></p>
    <div class="credits">
