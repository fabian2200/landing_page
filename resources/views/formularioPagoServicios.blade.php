...
<head>
    <title>ICP - Compra de Servicios</title>
    <meta charset="UTF-8">
...
<body>
    <main>
        <nav class="navbar navbar-expand navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" style="justify-content: end;">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a style="color:white !important;" class="nav-link btn btn-outline-light my-2 my-sm-0" href="/"><i class="fa fa-home"
                                aria-hidden="true"></i> Inicio</a>
                    </li>
                    <li class="nav-item" style="margin-left: 10px;">
                        <a style="color: black !important;" class="nav-link btn btn-warning my-2 my-sm-0" href="/servicio/{{ $servicio->id }}"><i class="fa fa-arrow-left"
        ...
        <input type="hidden" id="mercado-pago-public-key" value="APP_USR-10574fac-8e33-4e06-87ad-866661261d17">
        <!-- Payment -->
            ...
            <div class="container__payment" style="padding-top: 1%">
                <div class="form-payment row" style="max-width: 1300px">
                    <div class="products col-lg-4">
                        <h1 style="font-weight: bold; color: #343a40; text-align: center; font-size: 30px" class="detalles">RESUMEN DEL PEDIDO</h1>
                        <div class="item" style="margin-top: 10px; padding: 17px; background-color: #f2f3f3;border-radius: 10px;color: #384551;">
                            <span class="price" id="summary-price"></span>
                            <h6><strong style="color: #22247c">Tipo de servicio</strong></h6>
                            <h6>{{ $servicio->tipo }}</h6>
                            <hr>
                            <h6><strong style="color: #22247c">Servicio</strong></h6>
                            <h6>{{ $servicio->nombre }}</h6>
                            <hr>
                            <h6><strong style="color: #22247c">Modalidad</strong></h6>
                            <h6>{{ $modalidad }}</h6>
                            <div class="total">
                    ...
                    <div class="payment-details col-lg-8 row">
                        <div class="col-12 row">
                                ...
                                <form id="form-checkout">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-7">
                                            ...
                                            <input type="hidden" name="modalidad_tarjeta" id="modalidad_tarjeta" value="{{ $modalidad }}">
                                        </div>
                                    </div>
                                    <br>
                            ...
                            <div id="pse-pay" class="col-12" style="display: none">
                                ...
                                <br>
                                <form onsubmit="return confirmPayment()" action="/procesar-pago-servicios" method="post">
                                    @csrf
                                    ...
                                    <input type="hidden" name="description" id="description" value="{{ $servicio->tipo }} -  {{ $servicio->nombre }} - {{ $modalidad }}">
                                    <input type="hidden" name="modalidad" id="modalidad" value="{{ $modalidad }}">
    ...
    <script>
        ...
        function loadCardForm() {
            ...
            const productDescription = "{{$servicio->tipo}}" + " - " + "{{ $servicio->nombre }}" + " - " + "{{ $modalidad }}";
            ...
            const cardForm = mp.cardForm({
                ...
                callbacks: {
                    ...
                    onSubmit: event => {
                        ...
                        fetch("/procesar-pago-tarjeta-servicios", {
                            method: "POST",
                            headers: {
                            ...
                            body: JSON.stringify({
                                ...
                                modalidad: document.getElementById("modalidad_tarjeta").value,
                                payer: {
                                    email,
                                    identification: {
