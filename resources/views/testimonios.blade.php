    ...
    <section id="serviciosI" class="servicesI-section">
        <div class="container">
                <div class="row text-center mb-3">
                  ...
                  <p class="lead text-muted text-center">Compartimos el testimonio de algunos de nuestros clientes:</p>
                </div>
            </div>
          </div>  
  </section>
...
<!-- Services Section Item 1 -->                
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-card">
                        ...
                        <h3 class="service-title">CAROLINA VELANDIA FRANCO</h3>
                        <p class="description">Considero que el Diplomado es muy enriquecedor ya que nos ayuda para aplicar e interpretar los test de una manera profesional ya que el Doctor Antonio Martínez utiliza las técnicas adecuadas para transmitirnos el conocimiento y así alcanzar las expectativas que se tenía  frente  a este diplomado.
                        Lo recomiendo es una buena inversión, el mejor regalo que te puedes dar.</p>
...
<!-- Services Section Item 2 -->
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="service-icon">
                      ...
                      <h3 class="service-title">LLESIMEL DE LA ROSA MIRANDA/a></h3>
                      <p class="description">El seminario como tal me pareció EXCELENTE, ya que en mi caso no tenía el conocimiento completo de lo que era la prueba, conocía la prueba, pero de manera superficial. Resalto que esta clase de seminarios se deberían hacer constantes ya que son muy enriquecedores. A usted profesor, darle las gracias, es MUY EXPLICITO en cada una de las cosas que enseña, QUEDO SATISFECHA con lo aprendido en estos días de seminario. </p>
                  </div>
                </div>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-card">
                        <div class="service-icon">
                          ...
                          <h3 class="service-title">DANIELA BOLÍVAR M.</a></h3>
                          <p class="description">Mi experiencia en el diplomado fue enriquecedora, puesto que logre aclarar múltiples dudas que tenía con respecto a la aplicación e interpretación de pruebas psicológicas. Antonio: un excelente docente con capacidad de transmitir el conocimiento, buen dominio del tema, es claro con su explicación.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-card">
                        <div class="service-icon">
                          ...
                          <h3 class="service-title">ANA MARÍA HERNÁNDEZ</a></h3>
                          <p class="description">En General el diplomado permite ampliar el conocimiento adquirido durante la carrera de psicología, con la opción de profundizar en aquellos temas que se parecen viciados o que a los profesores no les parece importante dar a conocer</p>
                    </div>
                </div>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-card">
                        <div class="service-icon">
                          ...
                          <h3 class="service-title">JORGE ALBERTO PÉREZ D.</a></h3>
                          <p class="description">El curso dirigido por el Dr. Antonio Martínez ha sido de mucho provecho por su capacidad para explicar conceptos complejos como lo es el de las pruebas, con claridad y precisión es admirable. Recomiendo ampliamente sus eventos a quienes buscan dominar las técnicas de evaluación psicométrica con un enfoque práctico y profesional.</p>
                    </div>
                </div>
<!-- END Services Section Item 5 -->
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-card">
                        <div class="service-icon">
                          ...
                          <h3 class="service-title">LAURA GARCÍA ROYERO</a></h3>
                          <p class="description">El Diplomado en Psicología Organizacional del Instituto Colombiano de Psicometría bajo la guía experta del Dr. Antonio Martínez ha superado todas mis expectativas. La metodología aplicada es excepcional, facilitando un aprendizaje profundo y aplicable en mi vida profesional. Creo que es una muy buena inversión que definitivamente vale la pena hacer.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-card">
                        <div class="service-icon">
                          ...
                          <h3 class="service-title">PAOLA ANDREA HOYO G</a></h3>
                          <p class="description">Para mi participar en este diplomado con el Dr. Antonio Martínez fue una experiencia transformadora. Su habilidad para comunicar de manera clara y accesible temas complejos de psicometría es impresionante. Me siento más segura en mi trabajo gracias a su enfoque práctico y metodología efectiva.</p>
                    </div>
                </div>
<!-- END Services Section Item 7 -->
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-card">
                        <div class="service-icon">
                          ...
                          <h3 class="service-title">ALEXANDRA RAYO JULIO</a></h3>
                          <p class="description">El curso ofrecido por el Instituto Colombiano de Psicometría, guiado por el Dr. Antonio Martínez, ha sido una gran experiencia en mi carrera profesional. Su dominio del tema y su capacidad para transmitir conocimientos de manera didáctica y amena son extraordinarios. Llegué con muchas dudas acerca del manejo de las pruebas de selección y las pude aclarar todas.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-card">
                        <div class="service-icon">
                          ...
                          <h3 class="service-title">CLAUDIA REYES Z.</a></h3>
                          <p class="description">El seminario dirigido por el profesor Antonio Martínez fue una experiencia enriquecedora. Su compromiso con la calidad educativa y su dominio del contenido fueron evidentes en cada sesión. Recomiendo este seminario a todos los profesionales que buscan mejorar sus habilidades con la aplicación e interpretación de pruebas.</p>
                    </div>
                </div>
<!-- END Services Section Item 9 -->
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-card">
                        <div class="service-icon">
                          ...
                          <h3 class="service-title">CAROLINA DUARTE GIRALDO</a></h3>
                          <p class="description">Participar en el diplomado con el Dr. Antonio Martínez ha sido una excelente decisión. Su capacidad para simplificar conceptos complejos y su enfoque práctico han sido fundamentales para poder comprender conceptos complejos de la psicometría. Gracias al Instituto Colombiano de Psicometría por esta oportunidad</p>
                    </div>
                </div>
